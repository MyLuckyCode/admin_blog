	...
	<div class="list">
		<div class="mainWrap">
			<div class="tableHeader">
				...
				<div class="tableItem-11 tableItem">评论</div>
				<div class="tableItem-12 tableItem">置顶</div>
				<div class="tableItem-13 tableItem">创建时间</div>
				<div class="tableItem-14 tableItem">操作</div>
			</div>
			<div class="tableBody">
				...
				<div class="tableBodyItem">
					...
					<div class="tableItem-13 tableItem" title="{$value->date}">{$value->smallDate}</div>
					<div class="tableItem-14 tableItem">
						<div class="btn">

...
<div class="title">	
	<div class="titleView">
		<h3>修改轮播图</h3>
		<span @click="goShow({$tpl.get.page})">返回轮播器列表</span>
	</div>
</div>
...
<div class="content">
	<div class="form">
		<div class="name">
			<span>标  题：</span> <el-input placeholder="标题，用于鼠标经过时显示" value="" v-model="title" show-word-limit maxlength="10"></el-input>
		</div>
		<div class="target">
